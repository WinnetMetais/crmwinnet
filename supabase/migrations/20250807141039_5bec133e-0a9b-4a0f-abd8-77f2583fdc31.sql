...
-- Verificar se existem produtos básicos para teste (usando campos corretos)
INSERT INTO public.products (name, description, sku, cost_price, price, unit, category, active)
VALUES 
