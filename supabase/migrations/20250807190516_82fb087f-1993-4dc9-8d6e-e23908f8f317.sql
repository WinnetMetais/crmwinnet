-- Fix RLS performance issues - Drop specific existing policies first

-- Drop existing problematic policies specifically mentioned in linter
DROP POLICY IF EXISTS "product_categories_select" ON public.product_categories;

-- Now recreate with optimized versions using (select auth.uid()) for performance

-- Customer Types - Remove duplicate policies and create optimized ones
...
-- Notifications - User-specific policies with optimized auth calls
...
-- Transactions - Optimize existing policies
...
-- Carriers - Remove duplicates and optimize
...
-- Opportunities - Optimize auth calls
...
-- WhatsApp Messages - Optimize user-specific policies
...
-- Suppliers - Remove duplicates and optimize
...
-- Profiles - Optimize user-specific policies
...
-- Units - Remove duplicates and optimize admin policies
...
-- Customer Segments - Remove duplicate policies
