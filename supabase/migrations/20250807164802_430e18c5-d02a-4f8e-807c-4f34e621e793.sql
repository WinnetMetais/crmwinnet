...
'["cliente_nome", "produto", "quantidade", "valor", "prazo"]'::jsonb, true, true),
...
Equipe Winnet Metais
{{contato_vendedor}}', 
'["cliente_nome", "contato_vendedor"]'::jsonb, true, true),
...
*Winnet Metais*', 
'["cliente_nome", "data", "horario", "local", "assunto"]'::jsonb, true, true),
...
Equipe Winnet Metais', 
'["cliente_nome", "produto", "desconto", "data_limite", "telefone", "email"]'::jsonb, true, true);

-- Inserir configurações do sistema específicas para Winnet
INSERT INTO system_settings (setting_key, setting_value, description) 
SELECT setting_key, setting_value::jsonb, description FROM (VALUES 
  ('company_info', '{
    "name": "Winnet Metais",
