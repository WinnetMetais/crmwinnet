-- Índices de cobertura para FKs reportados pelo linter (2ª tentativa corrigindo units.base_unit_id)
-- Usamos CREATE INDEX IF NOT EXISTS para evitar conflitos e reaplicações idempotentes
