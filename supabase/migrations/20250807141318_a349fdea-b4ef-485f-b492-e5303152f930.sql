...
-- Reset dos sequences/contadores se existirem
-- Resetar contadores de qualidade de dados
...
-- Resetar contadores em outras tabelas
...
VALUES ('data_cleanup_completed', '{"date": "' || NOW()::text || '", "action": "removed_all_mock_data"}', 'Registro de limpeza de dados fictícios')
