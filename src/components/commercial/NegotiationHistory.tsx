...
export const NegotiationHistory = () => {
  ...
  const getTypeColor = (type: string) => {
    switch (type?.toLowerCase()) {
      case 'reunião':
      case 'meeting': return 'bg-info/15 text-info';
      case 'proposta':
      case 'proposal': return 'bg-success/15 text-success';
      case 'negociação':
      case 'negotiation': return 'bg-warning/15 text-warning';
      case 'fechamento':
      case 'closing': return 'bg-primary/15 text-primary';
